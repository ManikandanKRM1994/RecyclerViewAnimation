...
import com.krm.recyclerviewanimation.adapters.*
import com.krm.recyclerviewanimation.animators.FadeInAnimator
...
class AdapterSampleActivity : AppCompatActivity() {
    ...
    internal enum class Type {
        ...
        SlideInLeft {
            override operator fun get(context: Context): AnimationAdapter {
                return SlideInLeftAnimationAdapter(
                    MainAdapter(
                        context,
                        SampleData.LIST.toMutableList()
                    )
        ...
        SlideInRight {
            override operator fun get(context: Context): AnimationAdapter {
                return SlideInRightAnimationAdapter(
                    MainAdapter(
                        context,
                        SampleData.LIST.toMutableList()
                    )
